 ...
 * It represent a raw single digit
 */
class FlipDigit implements AnimationListener {
    ...
    public FlipDigit(Context act, int id, View view, OnAnimationComplete onAnimComplete) {
        ...
        flipImage_BackUpper = view.findViewById(R.id.FlipMeterSpinner_image_back_upper);
        flipImage_BackLower = view.findViewById(R.id.FlipMeterSpinner_image_back_lower);
        flipImage_FrontUpper = view.findViewById(R.id.FlipMeterSpinner_image_front_upper);
        flipImage_FrontLower = view.findViewById(R.id.FlipMeterSpinner_image_front_lower);
    ...
    public boolean isAnimating() {
        return (animation1.hasStarted() && !animation1.hasEnded()) || (animation2.hasStarted() && !animation2.hasEnded());
    }

    private void cancelAnimation() {
        flipImage_FrontLower.clearAnimation();
        flipImage_FrontUpper.clearAnimation();
        flipImage_BackLower.clearAnimation();
        flipImage_FrontUpper.clearAnimation();
        animation1.cancel();
        animation2.cancel();
    }
